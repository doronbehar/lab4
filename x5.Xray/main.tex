...
\begin{graph}
    \centering
    % TODO: Add graph of histograms of some metals, with x axis as a channel number
    %\includegraphics{}
    \caption{
...
\begin{graph}[ht!]
    \centering
    % TODO: Add graph of linear relation between channel number and energies.
    %\includegraphics{}
    \caption{
...
% TODO: SARAH fill in an R^2 value
